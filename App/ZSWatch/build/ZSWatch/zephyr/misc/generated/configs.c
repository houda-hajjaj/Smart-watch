...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_LIS2DE12_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DIS_MODEL_DEPRECATED_USED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZSL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZSL_PLATFORM_OPT, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZSL_BOUNDS_CHECKS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZSL_CLR_RGBF_BOUND_CAP, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_STDC_LIS2DE12, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LIS2DE12, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LIS2DE12_TRIGGER_NONE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LIS2DE12_ENABLE_TEMP, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LSM6DSO_TRIGGER_OWN_THREAD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LSM6DSO_TRIGGER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LSM6DSO_THREAD_PRIORITY, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LSM6DSO_THREAD_STACK_SIZE, 1024);
