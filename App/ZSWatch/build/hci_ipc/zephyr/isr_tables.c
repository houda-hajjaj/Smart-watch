...
struct _isr_table_entry __sw_isr_table _sw_isr_table[30] = {
	...
	{(const void *)0x10225a9, (ISR)0x10225ad}, /* 5 */
	...
	{(const void *)0x101ef75, (ISR)0x10225ad}, /* 10 */
